...
- **Recent rotas list** – The setup screen remembers your last 5/10 rotas (local or shared links) so you can reopen them with one tap, rename entries, and clear or change the limit in Settings.
