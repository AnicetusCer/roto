...
1. **Install the app on your phone**
   ...
   - F-Droid and Google Play listings are planned; once live you can install directly from those stores. Release APKs are published as `roto-v<version>.apk` on GitHub to match F-Droid’s Binaries pattern.
